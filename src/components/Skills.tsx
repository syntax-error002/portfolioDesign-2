...
interface Tool {
    name: string;
    logo: string;
    category: 'code' | 'nocode' | 'ai' | 'design' | 'devops';
}
...
const languages: Language[] = [
    ...
    { name: 'Expo', logo: 'https://static.expo.dev/static/brand/square-228x228.png' },
        ...
        <section className="section skills" id="skills">
            <div className="container">
                <div className="section-header">
                    <h2>Tech <span className="gradient-text">Arsenal</span></h2>
